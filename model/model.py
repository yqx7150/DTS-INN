...
def initialize_weights(net_l, scale=1): # 初始化权重
...
class InvISPNet(nn.Module):
    def __init__(self, channel_in=2, channel_out=2, subnet_constructor=subnet('DBNet'), block_num=8):
        ...
        channel_split_num = 18  #分离的通道数！！ 要修改
